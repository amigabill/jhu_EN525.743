...
#define WGMA ( _BV(WGM11) )
#define WGMB ( _BV(WGM13) | _BV(WGM12) )
...
class TimerOne
{
  ...
  public:
	...
	//TCCR1B = 0;         // original as downloaded
	//TCCR1B = _BV(WGM13);  // my testing (Bill Toner)
	TCCR1A = WGMA;
	TCCR1B = WGMB ;  // my testing (Bill Toner)
