...
{
    _shSerialPortZigbee.start(baud_rate);
}
...
//            _ZBfrmBufferRX[ZB_FRM_OFFSET_LENL] = Serial.read();
	    ...
	    if(ZB_RX_FRM_LEN == ZBfrmLen16bit)
	    {
            ...
            bytes_read = read( shSerialPortZigbee.shSerialPortFD, ptrZBbufFrmType, (ZBfrmLen16bit+1) );
